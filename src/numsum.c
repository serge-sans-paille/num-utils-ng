...
static double
sum (FILE * stream)
{				//this function calculates the sum of numbers from a file or stdin.
  double sum = 0.;
  double number = 0.;
  while (!feof (stream))
    {
...
{				//this function calculates the decimal portion of the final sum 
  int i = (int) d;
